import { openapi_website_cms_getLiveCasinoBanners, Response200Type, decodeResponse200 } from 'src/api_openapi/generated/openapi_website_cms_getLiveCasinoBanners';
...
export const getLiveCasinoBanners = {
    browser: {
        params: (): ParamsFetchType<void> => {
            return {
                type: MethodType.GET,
                url: '/api-web/get-live-casino-banners',
            };
        },
        decode: decode
    },
    express: {
        ...
        urlBrowser: '/api-web/get-live-casino-banners',
    },
    generateUrlApi: async (params: GenerateUrlApiParamsType<void>): Promise<GenerateUrlApiType> => {

        const response = await openapi_website_cms_getLiveCasinoBanners(params.API_URL, params.API_TIMEOUT, params.jwtToken, {
