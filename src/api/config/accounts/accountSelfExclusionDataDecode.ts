...
const modelConfig = {
    ...
    transactions: buildApiItemDefault(decodeString, ''),
...
export const decodeAccountSelfExclusion = buildModelValidator('Accounts self exclusion', modelConfig);

export type AccountSelfExclusionModelType = ReturnType<typeof decodeAccountSelfExclusion>;

export type AccountSelfExclusionError = {
    status: number,
    error: {
        error: string
    }
