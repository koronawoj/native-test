...
type GetLiveCasinoGamesUriResponseType = {
    type: 'ok',
...
export const getLiveCasinoDemoGamesUri = {
    ...
    express: {
        ...
        urlBrowser: '/api-web/launch-live-casino-demo-game',
    },
    generateUrlApi: async (params: GenerateUrlApiParamsType<GetLiveCasinoGamesUriParamsType>): Promise<GenerateUrlApiType> => {
        ...
        return {
            url: `${params.API_URL}/${params.API_UNIVERSE}/pragmatic-casino/casino/games/launch/demo?${query}`,
            passToBackend: true,
