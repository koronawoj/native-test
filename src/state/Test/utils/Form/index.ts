...
export const group = <IN extends FormRecordBox>(fields: IN, muteErrorFlag: boolean = true): FormModel<Model<IN>> => {
    ...
    const visitedWhenAllVisited = muteErrorFlag;

    return new FormModel(
        new FormGroupArray(fieldsValules, visitedWhenAllVisited),
        (): Result<Model<IN>> => {
            //@ts-ignore
