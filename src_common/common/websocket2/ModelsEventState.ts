...
import { SelectionModel, PriceType } from 'src_common/common/websocket2/models/SelectionModel/SelectionModel';
...
import { SportModelType, decodeSportModelFromSocket } from 'src_common/common/websocket2/modelsApi/Sport';
import { EventsCollectionQueryType, decodeEventListGroup, EventListGroupType } from 'src_common/common/websocket2/modelsApi/EventsCollectionQuery';
import { BoxModel } from 'src_common/common/websocket2/common/BoxModel';
import { CompetitionModelType, decodeCompetitionModel } from 'src_common/common/websocket2/modelsApi/Competition';
import { createResultReady, Result, createResultLoading } from '@twoupdigital/mobx-utils/libjs/Result';
import { decodeEventModel, EventModelType, decodeEventBasicModel, EventBasicModelType } from 'src_common/common/websocket2/modelsApi/Event';
import { decodeMarketResponse, MarketApiModelType, SelectionModelType, MarketModelType } from 'src_common/common/websocket2/modelsApi/Market';
import { SelectionAnimation } from 'src_common/common/websocket2/models/SelectionModel/SelectionAnimation';
import { SocketManager, CreateBoxType, SignalIdFnType, BoxModelSelectionType, BoxModelSportType, BoxModelCompetitionType, BoxModelMarketType, BoxModelEventType, BoxModelEventMarketsType, BoxModelQueryType, BoxModelRabMarketsType } from 'src_common/common/websocket2/SocketClient/SocketManager';
import { RemoteValueContext } from 'src_common/common/websocket2/SocketClient/RemoteValueContext';
...
import { decodeArrayRabMarket, RabMarketType } from 'src_common/common/websocket2/modelsApi/RabMarket';
